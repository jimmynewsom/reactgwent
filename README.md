...
and then once you are both ready and submit decks that takes you to the actual game screen. Users can now play regular cards, but most of the cards with special abilities don't work yet. Working on it.
I also haven't implemented the leader abilities or faction abilities yet. And once you finish a game it should update your win/loss stats, which is also a todo.
